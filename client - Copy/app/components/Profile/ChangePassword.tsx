        ...
        <div className="w-full">
            <form aria-required onSubmit={passwordChangeHandler} className='flex flex-col items-center'>
                ...
                <div className='w-[100%] 800px:w-[60%] mt-2'>
                    ...
                    <input className={`w-[95%] h-[40px] border border-[#37a39a] text-center text-black dark:text-[#fff] rounder-[3px] mt-8 cursor-pointer`}  required value="Update" type='submit' />
                </div>
            </form>
        </div>
      </div>
